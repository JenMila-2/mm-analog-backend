    ...
    public class SpringSecurityConfig {
        ...
        protected SecurityFilterChain filter (HttpSecurity http) throws Exception {
            ...
            http
                    ...
                    .requestMatchers(HttpMethod.GET,"/users/{username}/images").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "/users/{username}/images/{imageId}").hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.PUT, "/users/{username}/images/{imageId}").hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.DELETE, "/users/{username}/images/{imageId}").hasRole("ADMIN")

                    //----------------------------------------Endpoints Project Folder--------------------------------------
                    ...
                    .requestMatchers(HttpMethod.GET,"/projectfolders/{folderId}/images").hasRole("ADMIN")
                    ...
                    .requestMatchers(HttpMethod.PUT, "/projectfolders/{id}/user/{username}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/projectfolders/{id}/user/{username}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/projectfolders/{folderId}/images/{imageId}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE,"/projectfolders/{id}").hasAnyRole("ADMIN", "USER")
                    .requestMatchers(HttpMethod.DELETE,"/projectfolders/{folderId}/images/{imageId}").hasAnyRole("ADMIN", "USER")
                    ...
                    .requestMatchers(HttpMethod.POST,"/photologs/user/{username}/folder/{folderId}").hasAnyRole("ADMIN", "USER")
                    .requestMatchers(HttpMethod.PUT,"/photologs/{id}").hasAnyRole("ADMIN", "USER")
                    .requestMatchers(HttpMethod.PUT, "/photologs/{id}/folder/{folderId}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/photologs/{id}/user/{userId}").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE,"/photologs/{id}").hasAnyRole("ADMIN", "USER")

                    //----------------------------------------Endpoints Film Stock Inventory--------------------------------------
                    ...
                    .requestMatchers(HttpMethod.GET,"/image/{projectFolderId}/{imageName}").hasAnyRole("ADMIN", "USER")
                    .requestMatchers(HttpMethod.POST, "/upload/image").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST,"/upload/folder/image").hasAnyRole("ADMIN", "USER")
