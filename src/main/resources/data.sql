...
VALUES
    ...
    (109, 'Project color', 'Collection of photos shot with Kodak Portra 400.', 'Benniezzzzzz80'),
    (110, 'Project B&W', 'Collection of B&W portraits.', 'Benniezzzzzz80');
...
INSERT INTO photologs (id, photo_title, camera, film_stock, film_format, shot_at_iso, aperture, shutter_speed, exposure_compensation, date_taken, developed_by_lab, notes, folder_id, username)
VALUES
    (400, 'Color_1', 'Canon AE-1','Kodak Portra 400', '35mm', 400, 'f5.6', '1/60', '+1', '2023-04-01', 'Ontwikkelservice Foto Verweij', 'Shot on a trip to Paris', 109, 'User2'),
    (401, 'Color_2', 'Canon AE-1','Kodak Portra 400', '35mm', 400, 'f8', '1/60', '0', '2023-04-01', 'Ontwikkelservice Foto Verweij', 'Shot on a trip to Paris', 109, 'User2'),
    (402, 'Color_3', 'Canon AE-1','Kodak Portra 400', '35mm', 400, 'f8', '1/60', '0', '2023-04-01', 'Ontwikkelservice Foto Verweij', 'Shot on a trip to Paris', 109, 'User2');
...
INSERT INTO filmdevelopmentlogs (id, roll_name, project, camera, film_stock, film_format, shot_at_iso, development_process, status, roll_started, roll_finished, exposed, developed, scanned, developed_by_lab, username)
VALUES
    (400, 'Roll 10 - Kodak Portra', 'Project Color','Canon AE-1', 'Kodak Portra 400', '35mm', 400, 'C-41 Color', 'Done', '2023-04-01', '2023-05-01', true, true, true, 'Ontwikkelservice Foto Verweij', 'User2');